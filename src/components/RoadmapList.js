        ...
        <Slider {...this.settings}>
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic-rnd.png" alt="Formation of the team" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic-translated.png" alt="Translated Plasma Whitepaper into Japnese" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic-launch.png" alt="First Demo Launched on Testnet" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic-add-checkpoint.png" alt="Add Checkpoint Feature" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic.png" alt="Add Defragmentation Feature" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic_2.png" alt="Escrow App Demo Launched on Testnet" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/ic-gas-less.png" alt="Add Gas-less Exit feature by GasStation Network" />
          ...
          <Card>
            <CardBody>
              ...
              <img width="100%" src="/static/images/group-11.png" alt="Escrow App Demo Launched on Testnet" />
